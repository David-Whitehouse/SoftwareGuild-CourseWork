 ...
 */
package com.mycompany.allthemaths;
...
public class App {
    public static void main(String[] args) {
        ...
        // When decimals are removed the formulas will calculate using integers only and not doubles
        // If there are both an int and a double in one expression the system will return a double in order to be as accurate as possible
    }
